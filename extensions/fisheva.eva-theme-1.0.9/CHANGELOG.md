...
```UI
terminal.ansiBlack: [#000](https://github.com/fisheva/Eva-Theme/issues/000)/#fff
...
```UI
inputOption.activeForeground: [#000](https://github.com/fisheva/Eva-Theme/issues/000) → #fff
```
...
editor.findMatchHighlightBackground: [#324464](https://github.com/fisheva/Eva-Theme/issues/324464) → #6A707D59
editor.findMatchHighlightBorder: [#32446400](https://github.com/fisheva/Eva-Theme/issues/32446400) → #6A707D00
``` -->
...
```UI
//增加空格符透明度
editorWhitespace.foreground: [#535773](https://github.com/fisheva/Eva-Theme/issues/535773)/#BDBDBED8 → #535773BF/#BDBDBEB2
...
```UI
terminalCursor.background: [#000000](https://github.com/fisheva/Eva-Theme/issues/000000)/#000000 → #FFF/#FFF
...
editor.snippetFinalTabstopHighlightBorder: [#535773](https://github.com/fisheva/Eva-Theme/issues/535773)/#BDBDBED8
...
editorWhitespace.foreground: #2C313A → [#535773](https://github.com/fisheva/Eva-Theme/issues/535773)
```
...
```UI
editorIndentGuide.activeBackground: [#454963](https://github.com/fisheva/Eva-Theme/issues/454963)/#CED1D7 → #FF9070BF/#FC8357CC
```
...
```UI
breadcrumbPicker.background: #23272F/#E1E4EB → [#252830](https://github.com/fisheva/Eva-Theme/issues/252830)/#E5E8EF
```
...
editor.findMatchHighlightBorder: [#32446400](https://github.com/fisheva/Eva-Theme/issues/32446400)/#CFD2D900
editor.lineHighlightBorder: #2D303900/#E5E8EF00
editor.selectionHighlightBorder: [#00809900](https://github.com/fisheva/Eva-Theme/issues/00809900)/#00BEC400
editor.wordHighlightBorder: [#00809900](https://github.com/fisheva/Eva-Theme/issues/00809900)/#00BEC400
...
```UI
scrollbarSlider.activeBackground: [#00000022](https://github.com/fisheva/Eva-Theme/issues/00000022) → [#00000033](https://github.com/fisheva/Eva-Theme/issues/00000033)
scrollbarSlider.background: [#00000011](https://github.com/fisheva/Eva-Theme/issues/00000011) → [#00000022](https://github.com/fisheva/Eva-Theme/issues/00000022)
scrollbarSlider.hoverBackground: [#00000022](https://github.com/fisheva/Eva-Theme/issues/00000022) → [#00000033](https://github.com/fisheva/Eva-Theme/issues/00000033)
```
...
terminalCursor.background: [#000](https://github.com/fisheva/Eva-Theme/issues/000)/#000
...
```UI
editorCursor.background: [#000](https://github.com/fisheva/Eva-Theme/issues/000)/#000
...
editor.selectionHighlightBackground: #00BEC499 → [#006060](https://github.com/fisheva/Eva-Theme/issues/006060) → #0088997F → #006661D8 → #0080997F
editor.wordHighlightBackground: #00BEC499 → [#006060](https://github.com/fisheva/Eva-Theme/issues/006060) → #0088997F → #006661D8 → #0080997F
...
//Redesigned peekView
peekView.border: [#535773](https://github.com/fisheva/Eva-Theme/issues/535773)/#BDBDBED8
